...
- 验证系统登记、版本复核、发布、交付、凭据领取、DNS、握手、能力调用、升级、回滚、轮换和离场。
...
- 不为了验收绕过租户权限、Assignment、双人版本复核、工具批准或凭据一次领取门禁。
...
| PB   | 平台管理员 B，版本复核；可以由第二个测试账号承担，但不是本 PR 的独立代码审核人 | 平台     |
| OA   | 组织管理员                                                                     | tenant-a |
| TC   | 技术联系人                                                                     | tenant-a |
| U1   | 被授权普通成员                                                                 | tenant-a |
| U2   | 未授权普通成员                                                                 | tenant-a |
...
“不需要独立审核人”仅指 PR 代码审核。业务系统版本双人复核是产品门禁，PB 仍必须是不同于 PA 的平台管理员账号，不能绕过。
