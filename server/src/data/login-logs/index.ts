export { appendLoginLog, queryLoginLogs, clearLoginLogs, clearLogsByUsername, getLastActivePerUser, redactLegacyChatPreviewsInFile } from './store.js';
...
const ADMIN_ALWAYS_AUDITED: ReadonlySet<LoginEvent> = new Set<LoginEvent>([
  ...
  'cron_job_created', 'cron_job_updated', 'cron_job_deleted', 'cron_job_toggled', 'cron_job_triggered', 'cron_job_cancelled',
  ...
  'platform_user_search', 'billing_account_adjusted', 'billing_debit_reversed', 'billing_member_budget_updated',
