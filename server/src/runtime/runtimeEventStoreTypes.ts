...
export interface EventReplayLoadStats {
  strategy: 'full' | 'checkpoint' | 'incremental';
  totalEventCount: number;
  selectedEventCount: number;
  totalStoredBytes?: number;
  selectedStoredBytes?: number;
  selectedProjectedBytes?: number;
...
export interface EventListOptions {
   ...
   */
  replayMode?: 'bounded' | 'checkpoint';
  replayStats?: (stats: EventReplayLoadStats) => void;
  /**
