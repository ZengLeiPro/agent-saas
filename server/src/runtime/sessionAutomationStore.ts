...
export class PgSessionAutomationStore {
  ...
  async claimDue(limit=25,leaseMs=30_000):Promise<number>{return this.tx(async c=>{const r=await c.query(`WITH ranked AS (
