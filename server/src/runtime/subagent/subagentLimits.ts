 ...
 *   - 硬超时 60min + maxTurns 60：40 轮或 100 次工具调用后强制收束，剩余轮次
 *     只作异常保险；超时 = terminate + status:timeout。
 *
...
export const SUBAGENT_MAX_TURNS = 60;
export const SUBAGENT_FORCE_SYNTHESIS_AFTER_TURNS = 40;
export const SUBAGENT_FORCE_SYNTHESIS_AFTER_TOOL_CALLS = 100;
