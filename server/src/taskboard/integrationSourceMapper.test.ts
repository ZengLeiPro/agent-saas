...
const base = {
  ...
  repository_id: 'github:acme/app', source_order: 0, updated_at: '2026-08-26T06:00:00.000Z',
};
...
describe('rowToIntegrationSource', () => {
  it('does not require a reviewed PR revision for a source', () => {
    expect(rowToIntegrationSource({ ...base, state: 'pending' })).toEqual({
      ...
      repositoryId: 'github:acme/app', order: 0, state: 'pending', updatedAt: '2026-08-26T06:00:00.000Z',
    });
  });
