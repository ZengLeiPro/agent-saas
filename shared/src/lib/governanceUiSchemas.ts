...
export const governanceReceiptSchema = z.object({
  ...
  source: z.string().optional(), resourceType: z.string().optional(), mode: z.enum(['all', 'selected']).optional(),
...
const policySchema = z.object({
  ...
  version: z.number().int().positive(), ...persistedMetadataShape,
}).strict();
...
export const offboardingPreviewSchema = z.object({
  ...
  impact: z.object({
    ...
    cronOwnership: summarySchema, activeRuns: authoritySummarySchema.optional(), activeSessions: authoritySummarySchema.optional(),
    oauthGrants: authoritySummarySchema.optional(), externalConnections: authoritySummarySchema.optional(), personalMemory: summarySchema,
