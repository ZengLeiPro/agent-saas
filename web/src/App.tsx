...
function App() {
  ...
  const {
    ...
    removeFile, handleFileSelect, handlePaste, sendMessage, interjectMessage, sendVoiceMessage, stopping, stopGeneration, retryMessage, forkFromMessage,
  ...
  const layoutProps: LayoutProps = {
    ...
    sendMessage, interjectMessage, sendVoiceMessage, stopping, stopGeneration, handleFileSelect, handlePaste, ttsProps,
    queuedInterjections, cancelQueuedInterjection, editQueuedInterjection, resendQueuedInterjection, dismissQueuedInterjection,
