...
describe("统一分析侧栏", () => {
  it("平台管理员按平台、组织顺序展示 10 + 5 个页面", () => {
    ...
    expect(navigation.querySelectorAll("button")).toHaveLength(15);
  ...
  it("组织管理员只展示组织分析并可切换页面", () => {
    ...
    expect(screen.getByText("组织分析")).toBeTruthy();
    expect(screen.getByLabelText("分析导航").querySelectorAll("button")).toHaveLength(5);
