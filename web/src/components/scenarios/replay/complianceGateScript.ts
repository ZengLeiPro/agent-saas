      ...
      blocks: [
        {
          ...
          presentation: {
            title: "按欧盟准入规则逐项核验",
            detail: [
              { no: 1, text: "CE 符合性声明：有效期至 2027-05-30，主体与出口商一致 → 通过" },
              { no: 2, text: "EMC 检测报告：型号与本批次一致 → 通过" },
              { no: 3, text: "原产地证 CO-2025-0904：2026-06-30 已过期 → 不通过" },
              { no: 4, text: "RoHS 声明：签署主体是母公司，与出口商不一致 → 需人工判断" },
            ],
            status: "warn",
            panel: [
              { op: "focus", view: "evidence" },
        ...
        },
        {
          ...
          presentation: {
            ...
            detail: [
              { k: "请求数据域", v: "订单成本与毛利" },
              { k: "本人岗位", v: "外贸业务（出口合规）" },
              { tree: "└", k: "判定", v: "越权，按权限矩阵拒绝，未读取任何数据" },
            ],
            status: "blocked",
            panel: [
      ...
      blocks: [
        {
          ...
          presentation: {
            ...
            detail: [
              { k: "ERP 订单", v: "SO-2026-0731 · 合规状态：已放行" },
              { k: "证据台账", v: "4 项全部有效 · 旧证已作废" },
              { k: "审批系统", v: "放行单 AP-2026-0442 · 含 1 项人工修改" },
              { tree: "└", k: "分发链路", v: "1 个有效链接 · 48 小时 · 下载 0/2" },
            ],
            status: "ok",
            panel: [
              { op: "focus", view: "evidence" },
