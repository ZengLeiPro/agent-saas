      ...
      blocks: [
        {
          ...
          presentation: {
            ...
            detail: [
              { no: 1, text: "社保公积金申报：人员增减表（3 增 1 减）、缴费基数表已复核 → 齐套" },
              { no: 2, text: "出口退税申报：报关单 12 票、增值税专票 9 张、收汇核销 12 笔逐笔匹配 → 齐套" },
              { no: 3, text: "专利年费 ZL201820447153：缴费信息表、专利登记簿副本齐备 → 齐套" },
              { no: 4, text: "客户框架合同续签：材料齐套，但续签口径与用印须有权人拍板 → 转审批门禁" },
              { no: 5, text: "高新企业年度报表：2026 上半年研发费用辅助账尚未结转，导不出 → 缺件，不提交" },
            ],
            status: "warn",
            panel: [
              { op: "focus", view: "ledger" },
      ...
      blocks: [
        {
          ...
          presentation: {
            ...
            detail: [
              ...
              { k: "已确认办结", v: "2 项 · 均按受理编号回查金额与所属期一致" },
              { k: "已提交未确认", v: "2 项 · 出口退税受理回执、续签函对方签回" },
              { tree: "├", k: "未提交", v: "1 项 · 高新年报缺件，已指派并排定复查" },
              { tree: "└", k: "口径一致性", v: "台账 / 日报 / 通知三处对未结项的表述完全一致" },
            ],
            status: "warn",
            panel: [
              { op: "focus", view: "ledger" },
