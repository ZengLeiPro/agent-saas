...
function DropdownMenu(props: React.ComponentProps<typeof DropdownMenuPrimitive.Root>) {
  ...
  return <DropdownMenuPrimitive.Root {...props} {...(blocked ? { modal: false } : {})} />;
}
...
function DropdownMenuPortal({ container, ...props }: React.ComponentProps<typeof DropdownMenuPrimitive.Portal>) {
  ...
  return <DropdownMenuPrimitive.Portal container={container ?? contextContainer ?? undefined} {...props} />;
}

const preventBlockedDismiss = (event: Event) => event.preventDefault();
...
>(({ className, onEscapeKeyDown, onFocusOutside, onInteractOutside,
...
>(({ className, sideOffset = 4, onEscapeKeyDown, onFocusOutside,
