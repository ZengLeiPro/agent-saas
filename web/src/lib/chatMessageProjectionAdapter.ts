...
/** Web is intentionally a thin rendering adapter; all merge authority lives in shared. */
export function projectWebChatEvent(state: ActivityMessageProjectionState, event: WsEvent) {
