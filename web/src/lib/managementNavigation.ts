...
export const MANAGEMENT_PAGES: readonly ManagementPageDefinition[] = [
  ...
  {
    id: 'platform-external-agents',
    surface: 'config',
    area: 'platform',
    group: '资源目录',
    label: '外部 Agent',
    description: '管理外部调用身份、只读数据库连接和运行审计。',
    iconKey: 'key',
    routeId: 'platform.resource-center.external-agents',
    layout: 'collection',
  },
  {
  ...
  {
    id: 'organization-external-agents',
    surface: 'config',
    area: 'organization',
    group: '构建 · 调用资产',
    label: '外部 Agent',
    description: '管理本组织的外部调用身份、只读数据库连接和运行审计。',
    iconKey: 'key',
    routeId: 'organization.agents.external-agents',
    layout: 'collection',
  },
  {
    id: 'org-agents',
