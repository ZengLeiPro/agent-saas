...
export const SETTINGS_REGISTRY = defineSettingsRegistry([
  ...
  { scope: "personal", id: "my-permissions", label: "我的权限", description: "查看当前有效资源、权限与开通方式。", group: "access", iconKey: "admin", accessAction: "settings.personal.view", dirtyPolicy: "immediate", routeId: "settings.access.my-permissions" },
  ...
  { scope: "tenant", id: "settings", label: "功能与配额", iconKey: "org", accessAction: "settings.tenant.view", dirtyPolicy: "component-owned", targetRouteId: "organization.settings.general" },
  ...
  { scope: "platform", id: "demo-access", label: "演示访问", iconKey: "admin", accessAction: "settings.platform.view", dirtyPolicy: "component-owned", targetRouteId: "platform.org-business.demo-access" },
