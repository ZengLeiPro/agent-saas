...
If that directory does not exist, the skill was not synced to this workspace — report a platform skill-sync gap instead of searching for alternative paths.
